...
public static class MainPageLocators
{
    ...
    public static readonly By HomeBtnBy = By.CssSelector("button[data-testid='home-button']");
	public static readonly By SearchInputBy = By.CssSelector("input[data-testid='search-input'");
